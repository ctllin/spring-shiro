package com.github.zhangkaitao.shiro.spring.filter;

import com.github.zhangkaitao.shiro.spring.AppConst;
import com.github.zhangkaitao.shiro.spring.po.JsonResult;
    ...
    protected boolean onAccessDenied(ServletRequest servletRequest, ServletResponse servletResponse) throws IOException {
        ...
        if (!subject.isAuthenticated()) {
            ...
            if (requestURI.endsWith(".json")) {
                ...
                w.write(JSONObject.fromObject(jr).toString());
                w.flush();
                w.close();
            } else {
